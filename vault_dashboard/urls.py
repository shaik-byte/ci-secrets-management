...
urlpatterns = [
    ...
    path('settings/trusted-cidrs/create/', views.create_trusted_cidr, name="create_trusted_cidr"),
    path('settings/trusted-cidrs/<int:cidr_id>/update/', views.update_trusted_cidr, name="update_trusted_cidr"),
    path('settings/trusted-cidrs/<int:cidr_id>/delete/', views.delete_trusted_cidr, name="delete_trusted_cidr"),
